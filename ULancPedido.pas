...
function TLancPedido.PesquisarId: Boolean;
var
  sql : string;
begin
  Result := True;
  try
    ...
    Result :=  not uDmConexao.DataModule1.ADOQuery1.IsEmpty;

//    if Result then
//    begin
//      Self.NOME_CLIENTE := uDmConexao.DataModule1.ADOQuery1.FieldByName('NOME_CLIENTE').AsString;
//    end;
  except on E: Exception do
    begin
      Result := False;
